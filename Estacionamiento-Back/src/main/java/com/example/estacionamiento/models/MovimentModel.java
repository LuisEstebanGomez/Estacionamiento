...
public class MovimentModel {
    ...
    public MovimentModel(double monto, double saldoResultante, String tipo) {
        this.fecha = new Date();
        this.monto = monto;
        this.tipo=tipo;
    ...
    public CtaCteModel getCtaCte() {
        return ctaCte;
    }

    public void setCtaCte(CtaCteModel ctaCte) {
        this.ctaCte = ctaCte;
    }
