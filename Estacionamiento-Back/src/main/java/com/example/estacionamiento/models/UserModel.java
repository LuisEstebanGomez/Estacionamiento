...
public class UserModel  {
    ...
    private CtaCteModel cuentaCorriente;
	...
	public Object getEstacionamientoActivo() {
		return null;
	}

	public CtaCteModel getCuentaCorriente() {
		return this.cuentaCorriente;
	}

    public void setCuentaCorriente(CtaCteModel cuentaCorriente) {
	    this.cuentaCorriente = cuentaCorriente;
	    cuentaCorriente.setUser(this);
	}
